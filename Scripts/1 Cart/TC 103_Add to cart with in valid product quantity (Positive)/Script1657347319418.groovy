...
Mobile.verifyElementExist(findTestObject('Product Page/text_Product Name'), 10)
...
Mobile.setText(findTestObject('Product Page/Number of Order/input_text_Order Quantity'), '6', 15)
...
Mobile.verifyElementExist(findTestObject('Shopping Cart/text_Whoops, your cart is empty'), 15)
