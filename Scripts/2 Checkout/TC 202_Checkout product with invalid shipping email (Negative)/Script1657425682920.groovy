...
Mobile.setText(findTestObject('Checkout Page/input_text_your.emailgmail.com'), 'ini bukan email', 0)
...
Mobile.verifyElementNotVisible(findTestObject('Checkout Page/text_formheading_Process Checkout'), 0, FailureHandling.OPTIONAL)

Mobile.tap(findTestObject('Checkout Page/button_YES'), 0)

Mobile.verifyElementNotExist(findTestObject('Checkout Page/text_popupheading_Congratulation'), 25, FailureHandling.CONTINUE_ON_FAILURE)
