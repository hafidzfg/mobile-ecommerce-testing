...
Mobile.setText(findTestObject('Checkout Page/input_text_your.emailgmail.com'), GlobalVariable.profileEmail, 0)
...
Mobile.verifyElementVisible(findTestObject('Checkout Page/text_formheading_Process Checkout'), 0)

Mobile.tap(findTestObject('Checkout Page/button_YES'), 0)

Mobile.verifyElementVisible(findTestObject('Checkout Page/text_popupheading_Congratulation'), 0)

Mobile.tap(findTestObject('Checkout Page/button_OK'), 0)
