...
Mobile.setText(findTestObject('Checkout Page/input_text_Phone Number'), '', 0)

Mobile.delay(5, FailureHandling.STOP_ON_FAILURE)

Mobile.tap(findTestObject('Checkout Page/button_PROCESS CHECKOUT'), 0)

Mobile.verifyElementNotVisible(findTestObject('Checkout Page/text_formheading_Process Checkout'), 10)
